...
const App = (props) => {
    ...
    const handleClick = async () => {
        ...
        setPayline(paylines.result[paylineIndex]);
    ...
    return (
        <div>
            ...
            <div className={`spinner-container`}>
                <Spinner sprite={Sprite_1} array={sprite_1} index={winIcon} onFinish={finishHandler} ref={child1} result={true} number={payline?.first} />
                <Spinner sprite={Sprite_2} array={sprite_2} index={winIcon} onFinish={finishHandler} ref={child2} result={true} number={payline?.second} />
                <Spinner sprite={Sprite_3} array={sprite_3} index={winIcon} onFinish={finishHandler} ref={child3} result={true} number={payline?.third} />
            </div>
