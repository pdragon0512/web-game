...
export const RotationContainer = styled.div`
  ...
  &.started-spinning {
    animation: spin ${({ startSpinningTime }) => startSpinningTime / 1000}s
      ...
      continueSpin ${({ continueSpinningTime }) => continueSpinningTime / 1000}s linear
  ...
  @keyframes spin {
    ...
    to {
      transform: rotate(${props => props.startRotationDegrees + props.startingDegrees}deg);
    }
  }
  @keyframes continueSpin {
    ...
    to {
      transform: rotate(${props => props.startRotationDegrees + props.continueDegrees}deg);
    }
  }
  @keyframes stopSpin {
    from {
    ...
    to {
      transform: rotate(${props => props.stopDegrees + props.finalRotationDegrees}deg);
    }
  }
`;
